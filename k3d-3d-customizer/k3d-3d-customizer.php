...
/**
 * طبقة توليد ملفات التصنيع - Generation Manager + أداتر OpenSCAD (زي ما
 * هو موصوف في SRS Volume 6: OpenSCAD مجرد أداتر قابل للاستبدال بيولّد
 * ملفات STL/3MF بس، منفصل تمامًا عن معاينة الـ3D اللي فوق).
 */
